    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-10">
      ...
      <div className="p-3.5 rounded-xl bg-[#151D2E] border border-[#263247] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs text-[#94A3B8]">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <span className="font-semibold text-white">Risk Intelligence Workspace:</span>{' '}
            Risk record #{riskId} attributes, mitigation actions, and AI evaluation will be dynamically loaded in the next backend integration phase.
          </div>
        </div>
